...
def calc_and_save_flow(imAddr1, imAddr2, outAddr, ratio = 1.0):
    ...
    images = [pim1, pim2]
    print('after no crop: ' + str(np.array(images).shape))
...
testlist = [[11,12],[11,13],[12,11],[12,13],[13,11],[13,12],[15,16],[16,15]]
bright = 13
...
for ab in testlist:
    ...
    for b in range(bright):
        ad1 = '/home/zhangmf/Documents/data/dataset/newOptFlow/sony/processed/sid/%d/(%d).ARW_out_1.0.png'%(ima,b+1)
        ad2 = '/home/zhangmf/Documents/data/dataset/newOptFlow/sony/processed/sid/%d/(%d).ARW_out_1.0.png'%(imb,b+1)
        outad = './rebuttal/%d-%d_%d.flo'%(ima,imb,b+1)
        ratio = 50.0
